...
//parece que cria avaliaçoes para todo mundo e da nota nao tem como prever, o resultado varia no tempo
	...
	//	Recommender recommender =(Recommender) recs.get(0);
		...
		Recommender recommender = new RandomGuessRecommender () ;
		double acumGlobal = 0;
		double acumquad = 0;
		int countGlobal = 0;
        ...
        // build data model
		 ...
		 if(recs==null) {
		       ...
		       conf.set("data.input.path", "output_basico_cober_atu_ponderado_simp");//0.9966698653035351
        ...
        try {
			File2Lines fl= new  File2Lines("D:\\Users\\renat\\Documentos\\projetoia\\desenvolvimentolibrec\\librec\\data\\output_basico_cober_atu_ponderado_simp\\ratings_0.txt");
