...
import net.librec.recommender.cf.ranking.AspectModelRecommender;
import net.librec.recommender.cf.rating.SVDPlusPlusRecommender;
import net.librec.recommender.item.RecommendedItem;
import net.librec.similarity.PCCSimilarity;
import net.librec.similarity.RecommenderSimilarity;

public class MainAspectModelRecommender {
//parece que cria avaliaçoes para todo mundo e da nota nao tem como prever, o resultado varia no tempo
	...
	public static void main(final String[] args) throws Exception {
		...
		conf.set("rec.recommender.class","aspectmodelranking");
		conf.set("rec.item.distribution.parameter","500");
		conf.set("rec.iterator.learnrate","0.0001");
		conf.set("rec.iterator.learnrate.maximum","0.0001");
		conf.set("rec.iterator.maximum","20");
		conf.set("data.splitter.cv.number","5");
		conf.set("rec.pgm.burnin","10");
		conf.set("rec.pgm.samplelag","10");
		conf.set("rec.topic.number","10");
        ...
        // build recommender
        Recommender recommender = new AspectModelRecommender () ;
