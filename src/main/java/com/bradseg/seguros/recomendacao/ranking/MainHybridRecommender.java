...
public class MainHybridRecommender {
//parece que cria avaliaçoes para todo mundo e da nota nao tem como prever, o resultado varia no tempo
	...
	public static void main(final String[] args) throws Exception {
		...
		conf.set("rec.recommender.class","hybrid");
		conf.set("rec.hybrid.lambda","0.1");
		
		conf.set("rec.iterator.maximum","100");
		conf.set("rec.factory.number","30");
		conf.set("rec.iterator.learn.rate","0.001");
		...
		conf.set("rec.recommender.ranking.topn","200");
