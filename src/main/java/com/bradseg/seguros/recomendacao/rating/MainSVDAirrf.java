...
public final class MainSVDAirrf {
	...
	//	Recommender recommender =(Recommender) recs.get(0);
        ...
        // build data model
		 ...
		 if(recs==null) {
		       ...
		       conf.set("data.input.path", "test\\tfidftest");//0.9966698653035351
		   ...
		   //    conf.set("data.input.path", "v_output_nm_zona_cod_subgrupo"); //--1.0438038839664816 --4000
				...
				conf.set("rec.recommender.class","randomguess");
