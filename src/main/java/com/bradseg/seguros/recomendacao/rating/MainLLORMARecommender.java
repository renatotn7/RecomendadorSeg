...
import net.librec.recommender.cf.rating.LLORMARecommender;
...
public final class MainLLORMARecommender {
//parece que cria avaliaçoes para todo mundo e da nota nao tem como prever, o resultado varia no tempo
	...
	//	Recommender recommender =(Recommender) recs.get(0);
		...
		Recommender recommender = new LLORMARecommender () ;
		double acumGlobal = 0;
		double acumquad = 0;
		int countGlobal = 0;
        ...
        // build data model
		 ...
		 if(recs==null) {
		   ...
		   //    conf.set("data.input.path", "v_output_nm_zona_cod_subgrupo"); //--1.0438038839664816 --4000
				...
				conf.set("rec.recommender.class","llorma");
