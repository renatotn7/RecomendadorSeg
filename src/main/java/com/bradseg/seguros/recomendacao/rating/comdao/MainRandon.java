package com.bradseg.seguros.recomendacao.rating.comdao;
	        ...
	        // build data model
			 ...
			 if(recs==null) {
			   ...
			   //    conf.set("data.input.path", "v_output_nm_zona_cod_subgrupo"); //--1.0438038839664816 --4000
					...
					conf.set("rec.iterator.maximum","3000");
					conf.set("rec.user.regularization","0.2"); //0.4 1.9511897034611143
					...
					conf.set("rec.recommender.ranking.topn","100000");
				...
				//	0.5842856505964263 3000
			       ...
			       DaoDataModel dataModel = new DaoDataModel(conf,ratings,"UIR");
